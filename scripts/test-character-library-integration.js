...
async function testCharacterLibraryIntegration() {
  ...
  try {
    ...
    console.log(`   Consistency Threshold: ${config.CHARACTER_LIBRARY_CONFIG.consistencyThreshold}%`)
    
    console.log('')

    // Test 3: API Endpoint Test
    console.log('3. Testing API endpoint...')
    const response = await fetch('http://localhost:3000/v1/character-library/health')
