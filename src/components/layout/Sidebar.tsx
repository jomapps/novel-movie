...
export default function Sidebar({ isOpen, onToggle, pageTitle }: SidebarProps) {
  const pathname = usePathname()
  const { selectedProject } = useSelectedProject()

  // Project-specific navigation items
  const navigation: NavItem[] = selectedProject
    ? [
        {
          name: 'Project',
          ...
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0V3a1 1 0 011 1v11.586a1 1 0 01-.293.707L15 19H9l-2.707-2.707A1 1 0 016 15.586V4a1 1 0 011-1z"
              />
            </svg>
          ),
        },
